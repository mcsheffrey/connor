...
function nick(){animating=!1;clearTimeout(timer)}(function(e){function a(t){var a=i;t==="next"?++o:--o;if(o===0){o=s;a=u-i;t="next"}else if(o-1===s){o=1;a=0}f(n,a,t);console.log(o);e(r).eq(o).addClass("active").children().removeClass("active")}function f(t,n,r){var i,u=e("#bioonc #bg-scroll").width(),a=e("#bioonc").width(),f=(u-a)/s*o;console.log(r);r==="next"&&t.css({"-webkit-transform":"translate3d("+o+"px,0,0)"});console.log(i,n);r==="next"?e("#bioonc #bg-scroll").css({"-webkit-transform":"translate3d("+ -f+"px,0,0)"}):e("#bioonc #bg-scroll").css({"-webkit-transform":"translate3d("+f+"px,0,0)"})}var t=e("#bioonc"),n=e("#bioonc").find(".hero ul"),r=n.children("li"),i=e(r).eq(0).outerWidth(!0),s=r.length,o=1,u=s*i;console.log(n,r,i,s,o,u);e(n).width(u);t.find("#next").text(s);e("#bioonc").find("button").on("click",function(){var t=e(this).data("dir");a(t)});n.swipe({swipeMoving:function(e){console.log(e)},swipeLeft:function(){a("prev")},swipeRight:function(){a("next")}})})(jQuery);var $projects=$(".section").length,current=0,dir="next",pos=0,animating=!1,timer;$("body.work").bind("mousewheel",function(e,t,n,r){e.preventDefault();if(animating){clearTimeout(timer);timer=setTimeout(nick,50);return!1}if(r<.025){if(pos!==$projects){animating=!0;console.log("start scrolling");timer=setTimeout(nick,50);$.scrollTo(".section:eq("+ ++pos+")",600,{easing:"easeInOutQuart",axis:"y",onAfter:function(){console.log("done scrolling")}})}}else if(r>-0.025&&pos!==0){animating=!0;timer=setTimeout(nick,50);$.scrollTo(".section:eq("+ --pos+")",600,{easing:"easeInOutQuart",axis:"y",onAfter:function(){}})}console.log(dir);console.log($projects);console.log(pos);return!1});$("#work").on("click",function(e){e.preventDefault();$.scrollTo(".section:eq(1)",600,{easing:"easeInOutQuart",axis:"y"});pos++});getTwitters("twitter",{id:"mcsheffrey",count:1,enableLinks:!0,ignoreReplies:!0,clearContents:!0,template:'"%text%" <a href="http://twitter.com/%user_screen_name%/statuses/%id_str%/"> ~ %time%</a>'});